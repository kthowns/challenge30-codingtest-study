package vanillacake369.Lv2.brute_force_2;
...
public class GOrH2 {
    ...
    public static void main(String[] args) {
        ...
        // 정렬
        List<Signpost> signpostArrayListAsc = signpostArrayList.stream().sorted().collect(Collectors.toList());
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (possibleIndexs.size() > 0) {
                maxPhotoSize = Math.max(maxPhotoSize,
                        (possibleIndexs.get(possibleIndexs.size() - 1) - signpostArrayListAsc.get(i).index));
            }
        }
